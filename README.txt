...
The code is divided into numerous classes where each class controls a different part of the game.
...
To run the code you run the GUI2048.java file as a Java Application